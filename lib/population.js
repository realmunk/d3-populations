var Population = function (population) {
    ...
    self.genderDist = function (b) {
        var name = population.name;

        if (b) {
            name = d3.min(population.data, function (d) { return age(d); }) + " - " + d3.max(population.data, function (d) { return age(d); });
        };
    ...
    self.genderDistAge = function (r) {
        ...
        return ageDist.sort(function (a, b) {
            ...
            .map(function (a) {
                return Population({name: age(a[0]), data: a}).genderDist(true);
            });
    };
    ...
    self.genderDistAgePct = function (r) {
        ...
        return ageDist.sort(function (a, b) {
            ...
            .map(function (a) {
                return Population({name: age(a[0]), data: a}).genderDistPct(true);
            });
    };
    ...
    self.genderDistTime = function (r) {  
        ...
        return ageDist.sort(function (a, b) {
            ...
            .map(function (a) {
                return Population({name: employed(a[0]), data: a}).genderDist();
            });
    };
